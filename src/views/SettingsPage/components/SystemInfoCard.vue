    ...
    <div class="info-list">
          ...
          <div class="info-row">
            ...
            <div class="info-value">
              <el-tag :type="serverStatus === 'running' ? 'success' : 'danger'" round>
          ...
          <div class="info-row">
            ...
            <div class="info-value">
              <el-tag :type="dbStatus === 'connected' ? 'success' : 'danger'" round>
                <span class="status-indicator" :class="dbStatusClass"></span>
                {{ dbStatusText }}
              </el-tag>
            </div>
          </div>
            ...
            <div class="info-value">
              <div class="storage-progress">
                <el-progress
                  ...
                  :show-text="false"
                />
                <div class="storage-text">{{ storageUsage }}% 已使用 ({{ usedStorage }} / {{ totalStorage }})</div>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  setup() {
    ...
    const serverStatusClass = computed(() => {
      return serverStatus.value === 'running' ? 'status-active' : 'status-inactive';
    });
    ...
    const dbStatusClass = computed(() => {
      return dbStatus.value === 'connected' ? 'status-active' : 'status-inactive';
    });
